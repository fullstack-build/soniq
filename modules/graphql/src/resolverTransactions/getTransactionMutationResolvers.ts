...
import { ICustomFieldResolver } from ".";

// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function getBeginTransactionResolver(pgPool: Pool, logger: Logger): ICustomFieldResolver<any, any> {
  return async (obj, args, context, info, revertibleResult) => {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
export function getCommitTransactionResolver(pgPool: Pool, logger: Logger): ICustomFieldResolver<any, any> {
