...
class EditExpressionParamTag extends Component {
  constructor(props) {
    super(props);
  ...
  renderTag() {
    ...
    if (placeholder != null) {
      ...
      if (placeholder.inputType === "FOREIGN_TABLE") {
        ...
        return <PropertyBox label={ paramKey } value={ (value != null && tableLabelById[value] != null) ? tableLabelById[value] : "__PLEASE SELECT__" } backgroundColor="rgb(255, 235, 0)" color="#000000" />;
      }
      if (placeholder.inputType === "FOREIGN_COLUMN") {
        ...
        return <PropertyBox label={ paramKey } value={ (value != null && columnLabelById[value] != null) ? columnLabelById[value] : "__PLEASE SELECT__" } backgroundColor="rgb(255, 144, 0)" color="#ffffff" />;
      }
      if (placeholder.inputType === "LOCAL_COLUMN") {
        ...
        return <PropertyBox label={ paramKey } value={ (value != null && columnLabelById[value] != null) ? columnLabelById[value] : "__PLEASE SELECT__" } backgroundColor="rgb(207, 247, 0)" color="#000000" />;
      }
  ...
  renderPopup() {
    const { styles, value, paramKey, onChange, appConfig, table, expression, appliedExpression, placeholder } = this.props;

    const headers = [{key: "Applied-Expression", value: appliedExpression.name}, {key: "Param", value: paramKey}];
...
export default connect(style)(EditExpressionParamTag);