...
const lib_1 = require("../../di/lib");
const lib_2 = require("../../boot-loader/lib");
let Config = class Config {
    ...
    HELPER
     */
    deepMapHelper(obj, iterator, context, nestedPath) {
...
Config = __decorate([
    di_1.Service(),
    __param(0, lib_1.Inject(type => lib_2.BootLoader)),
