...
function generateCustomSql(match, customs, getParam, getField) {
    function createOperator(operatorName, fieldName, value) {
        if (compareOperators_1.operatorsObject[operatorName] == null) {
        ...
        if (compareOperators_1.operatorsObject[operatorName].unsafeValue === true) {
        ...
        const requiresArray = compareOperators_1.operatorsObject[operatorName].value[0] === '[';
        ...
        return compareOperators_1.operatorsObject[operatorName].getSql(context);
    }
...
exports.generateCustomSql = generateCustomSql;
