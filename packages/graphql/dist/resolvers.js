...
function getResolvers(operations, resolversObject, hooks, dbGeneralPool, logger) {
    const queryResolvers = {};
    const mutationResolvers = {};
    // Add  queries to queryResolvers
    Object.values(operations.queries).forEach((operation) => {
    ...
    Object.values(operations.mutations).forEach((operation) => {
        if (resolversObject[operation.resolver] == null) {
