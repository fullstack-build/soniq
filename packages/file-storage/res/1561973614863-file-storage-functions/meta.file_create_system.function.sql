...
CREATE OR REPLACE FUNCTION _meta.file_create_system(i_extension TEXT, i_type TEXT) RETURNS uuid AS $$
DECLARE
    v_is_admin BOOLEAN;
    v_user_id uuid;
    v_file_id uuid;
...
BEGIN
    ...
    EXECUTE format('INSERT INTO "_meta"."Files"("extension", "type") VALUES(%L, %L) RETURNING id', i_extension, i_type) INTO v_file_id;
