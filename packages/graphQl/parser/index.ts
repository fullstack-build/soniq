...
export function runtimeParser(userSchema: any, views: IViews, expressions: IExpressions, dbObject): any {
  ...
  const {
    ...
    mutations,
    customFields
  } = createPublicSchema(classification, views, expressions, dbObject);
