...
function parseReadField(ctx) {
    ...
    Object.values(sameExpressionSets).forEach((expressionSet) => {
        const jsonExpression = utils_1.getJsonObjectBuilderExpression(expressionSet.matchObject, fieldName, localTable);
