...
export declare function createConstraint(constraintName: string, constraintType: 'PRIMARY KEY' | 'notnull' | 'UNIQUE' | 'CHECK', options: any, refDbMeta: any, refDbMetaCurrentTable: any, refDbMetaCurrentTableColumn?: any): void;
