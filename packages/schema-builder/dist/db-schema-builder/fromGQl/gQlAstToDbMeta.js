...
var directiveParser_2 = require("./directiveParser");
exports.registerDirectiveParser = directiveParser_2.registerDirectiveParser;
exports.parseGQlAstToDbMeta = (gQlAST) => {
    // result dbMeta
    const dbMeta = {
        version: 1.0,
        schemas: {},
...
function parseASTNode(gQlSchemaNode, dbMetaNode, dbMeta, refDbMetaCurrentTable, refDbMetaCurrentTableColumn) {
...
const GQL_JSON_PARSER = {
    ...
    Directive: (gQlDirectiveNode, dbMetaNode, refDbMeta, refDbMetaCurrentTable, refDbMetaCurrentTableColumn) => {
        ...
        if (directiveParser_1.getDirectiveParser(directiveKindLowerCase) != null) {
