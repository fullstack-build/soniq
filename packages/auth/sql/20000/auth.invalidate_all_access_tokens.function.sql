...
BEGIN
    ...
    v_query := $tok$ UPDATE "_auth"."UserAuthentication" SET "invalidTokenTimestamps" = ARRAY[]::BIGINT[], "totalLogoutTimestamp" = (round(extract(epoch from now())*1000))::bigint WHERE "id" = %L; $tok$;
