...
let Auth = class Auth extends ONE.AbstractPackage {
    constructor($one) {
        super();
        this.$one = $one;
    ...
    register(username, tenant) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield this.dbGeneralPool.connect();
            try {
                // Begin transaction
    ...
    linkPassport() {
        ...
        this.$one.app.keys = [sign_1.getCookieSecret()];
        authRouter.use(koaSession(this.authConfig.oAuth.cookie, this.$one.app));
        authRouter.use(passport.initialize());
        // authRouter.use(passport.session());
        this.$one.app.use((ctx, next) => __awaiter(this, void 0, void 0, function* () {
...
], Auth.prototype, "dbGeneralPool", void 0);
Auth = __decorate([
    ONE.Service(),
    __param(0, ONE.Inject(type => ONE.FullstackOneCore)),
