...
let Auth = class Auth {
    constructor(dbGeneralPool, server, bootLoader, schemaBuilder, config, graphQl, loggerFactory) {
        this.possibleTransactionIsolationLevels = [
            "SERIALIZABLE",
            "REPEATABLE READ",
            "READ COMMITTED",
            "READ UNCOMMITTED"
    ...
    addMiddleware() {
        ...
        const corsOptions = Object.assign({}, this.authConfig.corsOptions, { origin: (ctx) => {
            ...
            if (mutation.extensions.auth === "REGISTER_USER_MUTATION") {
                ...
                if (this.isPrivacyAgreementCheckActive() === true) {
                    ...
                    if (args.input[privacyAgreementAcceptedAtInUTC] == null || args.input[privacyAgreementAcceptedVersion] == null) {
                        throw new Error(`The privacy-fields ('${privacyAgreementAcceptedAtInUTC}',` + ` '${privacyAgreementAcceptedVersion}') are required for creating a user.`);
                    }
                    ...
                    if (tokenPayload.acceptedVersion !== this.authConfig.privacyAgreementAcceptance.versionToAccept) {
                        throw new Error("The accepted version of your privacy-token is not version" + ` '${this.authConfig.privacyAgreementAcceptance.versionToAccept}'.`);
                    }
                }
        ...
        return {
            "@fullstack-one/auth/login": (obj, args, context, info, params) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (context.ctx.securityContext.isBrowser === true) {
                    ...
                    return Object.assign({}, lData, { sessionExpirationTimestamp: lData.payload.timestamp + lData.payload.userTokenMaxAgeInSeconds * 1000 });
                }
            }),
    ...
    login(username, tenant, password, authToken, clientIdentifier) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield this.setAdmin(dbClient);
                const loginResult = yield dbClient.query("SELECT _meta.login($1, $2, $3, $4) AS payload", [
                    data.userId,
                    provider,
                    pwData.hash,
                    clientIdentifier
    ...
    getCurrentUserIdFromAccessToken(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.userTransaction(accessToken, (dbClient) => __awaiter(this, void 0, void 0, function* () {
